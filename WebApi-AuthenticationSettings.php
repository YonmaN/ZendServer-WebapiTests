...
$uri = Zend_Uri::factory('http://yonni-desktop:10081/ZendServer/Api/userAuthenticationSettings');
/**
...
$client->setParameterPost('password', '111');
$client->setParameterPost('type', 'simple');
$client->setParameterPost('ldap', array(
));
