...
$uri = Zend_Uri::factory('http://yonni-desktop:10081/ZendServer/Api/setPassword');
/**
...
$client->setParameterPost('password', '1234');
$client->setParameterPost('newPassword', '1234');
$client->setParameterPost('confirmNewPassword', '1234');
