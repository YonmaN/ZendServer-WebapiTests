...
$uri = Zend_Uri::factory('http://yonni-desktop:10081/ZendServer/Api/libraryVersionGetStatus');
/**
...
$client->setParameterGet('libraryVersionId', 11);
// 	$client->setCookie('debug_host', '10.1.2.42');
