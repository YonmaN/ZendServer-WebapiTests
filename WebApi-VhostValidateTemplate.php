...
$uri = Zend_Uri::factory('http://yonni-desktop:10081/ZendServer/Api/vhostValidateTemplate');
/**
...
$client
	...
	->setHeaders(array(
		...
		'Accept'	=> 'application/vnd.zend.serverapi;version=1.7'
	));

$client->setParameterPost('template', 'boom');
$client->setParameterPost('name', str_repeat('1', 64));
$client->setParameterPost('port', 111);
