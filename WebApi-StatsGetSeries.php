...
$uri = Zend_Uri::factory('http://yonni-desktop:10081/ZendServer/Api/statisticsGetSeries');
/**
...
$client
	...
	->setHeaders(array(
        ...
        ->setParameterGet('type', 505)
        ->setParameterGet('from', strtotime('-2 day'))
        ->setParameterGet('appId', 0)
;
