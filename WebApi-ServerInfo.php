...
$uri = Zend_Uri::factory('http://yonni-desktop:10081/ZendServer/Api/get2ServerInfo');
/**
...
$client
	...
	->setHeaders(array(
		...
		'Accept'	=> 'application/vnd.zend.serverapi+json;version=1.4'
	))->setParameterGet('serverId', 0);
