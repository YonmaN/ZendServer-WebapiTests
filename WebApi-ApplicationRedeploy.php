...
$uri = Zend_Uri::factory('http://yonni-desktop:10081/ZendServer/Api/applicationSynchronize');
/**
...
$client
	...
	->setHeaders(array(
		...
		'Accept'	=> 'application/vnd.zend.serverapi+json;version=1.2'
	));
        
$client->setParameterPost('appId', '11');
// $client->setParameterPost('servers', array(1,2,3,0));
