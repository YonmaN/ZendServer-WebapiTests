...
$uri = Zend_Uri::factory('http://yonni-desktop:10081/ZendServer/Api/libraryVersionDeploy');
/**
...
$client
	...
	->setFileUpload('/usr/zlocal/packaging/qa-stuff/apps/ZF2/zf2-2_0.zpk', 'fileupload');
