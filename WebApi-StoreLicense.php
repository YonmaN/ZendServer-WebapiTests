...
$uri = Zend_Uri::factory('http://yonni-desktop:10081/ZendServer/Api/serverStoreLicense');
/**
...
$client->setParameterPost('licenseName', 'pe');
$client->setParameterPost('licenseValue', 'IG127010001G01DD07DE550D54621365');
