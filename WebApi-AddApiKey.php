...
$uri = Zend_Uri::factory('http://yonni-desktop:10081/ZendServer/Api/apiKeysAddKey');
/**
...
$client
	...
	->setHeaders(array(
		...
		'Accept'	=> 'application/vnd.zend.serverapi+xml;version=1.4'
	));

$client->setParameterPost('name', 'boom'.rand());
$client->setParameterPost('username', 'admin');
// $client->setParameterPost('hash', str_repeat('1', 64));
